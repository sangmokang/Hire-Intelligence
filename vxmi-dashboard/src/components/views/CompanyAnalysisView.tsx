...
import { COMPANY_DB, DEFAULT_COMPANY_BTNS } from '../../data/companyProfiles'
...
export function CompanyAnalysisView() {
  ...
  const profile = COMPANY_DB[selectedCompany] ?? null
    ...
    <div>
      ...
      {!profile ? (
        <p className="text-sm text-gray-500">
          "{selectedCompany}" 데이터를 찾을 수 없습니다.
        </p>
      ) : (
        <>
